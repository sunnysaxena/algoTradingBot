...
def fetch_ohlc(symbol: str, interval: str = '15m', limit: int = 100):
    """Fetch historical OHLC data from database for 15m interval."""
    query = f"""
...
def main():
    symbol = 'NIFTY50'
    df = fetch_ohlc(symbol, interval='15m')
    if df.empty:
    ...
    logging.info("Support and Resistance Levels (15m Interval):")
